...
export default class RequestResetPopup extends PureComponent {
  ...
  sendRequest = () => {
    userService
      .resendPasswordEmail(this.state.user)
  ...
  validateFields = () => {
    ...
    if (!Validators.email(user)) return false;
  ...
  pickPopup = () => {
    ...
    switch (this.state.type) {
      case types.FORM:
        return (
          <Popup title="Olvidé la constraseña" onClickOutside={close}>
            <MainContainer>
              <MessageContainer>
                <Phrase>
                  {' '}
                  Ingresa tu correo electrónico para que podamos enviarte un mail para restablecer tu contraseña.{' '}
                </Phrase>
              </MessageContainer>
              ...
              <Form onSubmit={this.onSubmit}>
                ...
                <FormButton name="Restaurar contraseña" onClick={this.onSubmit} loading={loading} />
              </Form>
            </MainContainer>
          </Popup>
        );
      case types.SUCCESS:
        return (
          <Popup title={'Mail enviado'} icon={{ name: 'check-circle-o', color: primary }} onClickOutside={close}>
            <MainContainer>
              <MessageContainer>
                <Phrase> Hemos enviado un nuevo e-mail a tu correo electrónico. </Phrase>
                <Phrase>
                  {' '}
                  Sigue las instrucciones contenidas en él para que puedas establecer una nueva contraseña{' '}
                </Phrase>
              </MessageContainer>
              <ButtonContainer>
